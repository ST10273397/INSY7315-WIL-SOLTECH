...
namespace ElevatedTutors.Models
{
    public class StudentUser
    {
        ...
        public StudentUser(string userId, string parentEmail, decimal marks, List<Subject> subjects, List<Session> sessions, int maxSessions, List<Submission> submissions)
        {
            UserId = userId;
